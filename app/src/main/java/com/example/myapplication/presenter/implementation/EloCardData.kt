...
class EloCardData(private val externalData: CreditCard) : CreditCardData {
    ...
    override fun getBrandIcon(): Int = R.drawable.ic_cartao_elo

    override fun getCardColor(): Int = R.color.blue_hard
}